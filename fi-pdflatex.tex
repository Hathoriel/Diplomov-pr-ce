...
V další fázi bude na serveru \texttt{shongo-autn.cesnet.cz} následovat implementace procesu, který zajistí propojení s autorizačním serverem OpenID Connect. Uvedená implementace zaručí mapování nově získaných uživatelských dat do stávajícího mechanizmu autentizace a autorizace uživatele. \par
...
\begin{tabular}{ |c|c| } 
 \hline
 LoadModule auth\_openidc\_module /usr/lib/apache2/modules/mod\_auth\_openidc.so & cell2  \\ 
 cell4 & cell5 \\ 
 cell7 & cell8 \\ 
 \hline
\end{tabular}
