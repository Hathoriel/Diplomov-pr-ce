...
\end{itemize}
Dále jsou získány již známé informace o křestním jménu, příjmení a emailové adrese uživatele. Uvedené informace o uživateli jsou uloženy do již popisovaného objektu třídy \texttt{ShongoAuthn\textbackslash User\textbackslash User}. \par
Po té se předá řízení algoritmu zpět do metody \texttt{dispatch} v třídě \texttt{Authorize}. V této metodě je dále vytvořen textový řetězec session TODO.  
