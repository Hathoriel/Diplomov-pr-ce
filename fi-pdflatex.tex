...
Dalším fází integrace s OpenID Connect bylo vytvoření validátoru OIDCUser.php, který kontroluje zda autentizovaný uživatel patří do skupiny einfra. Logika zmíněného validátoru spočívá v tom, že kontroluje zda je v seznamu skupin \textbf{OIDC\_CLAIM\_eduPersonEntitlement} do kterých uživatel patří přítomen řetězec \texttt{urn:geant:cesnet.cz:group:einfra:einfra\#perun.cesnet.cz}.  
\par
TODO napsat co bylo vynecháno, které služby se zrušily, o co se infrastruktura zjednodušila
