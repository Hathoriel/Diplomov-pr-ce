...
\par  
Na straně zdrojového kódu je v souboru \texttt{cz/cesnet/shongo/controller/api/Controller.java} délka sloupce definovaná v proměnné \texttt{USER\_ID\_COLUMN\_LENGTH}. Ta je typu VARCHAR a byla změněna z délky 32 na 100. Dále byla provedena změna délky sloupce v databázových tabulkách pomocí následujícího SQL příkazu.
