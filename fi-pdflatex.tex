...
Po nastavení uvedené konfigurace, mohlo dojít ke stanovení URL adres, které pro přístup požadují OpenID Connect autentizaci. Zmíněnou ochranu adres pro Adobe Connect popisuje pomocí Apache direktiv \textbf{Location}, \textbf{AuthType} a \textbf{Require} následující výňatek z konfiguračního souboru Apache.
...
Obdobně ochranu URL adres autentizačního serveru \texttt{shongo-auth.cesnet.cz}, který se stará o autentizaci a autorizaci uživatelů přistupujících na server \texttt{meetings.cesnet.cz} zajišťuje následující úryvek. 
